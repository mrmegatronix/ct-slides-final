    ...
    <div className="relative w-full h-full overflow-hidden font-sans bg-black">
      ...
      <style>{`
        ...
        @keyframes flame-flicker {
          0%, 100% { filter: drop-shadow(0 0 15px rgba(255, 160, 0, 0.4)) drop-shadow(0 0 30px rgba(255, 69, 0, 0.2)); transform: scale(1); }
          25% { filter: drop-shadow(0 0 20px rgba(255, 180, 0, 0.6)) drop-shadow(0 0 40px rgba(255, 50, 0, 0.3)); transform: scale(1.005); }
          50% { filter: drop-shadow(0 0 15px rgba(255, 150, 0, 0.5)) drop-shadow(0 0 35px rgba(255, 100, 0, 0.25)); transform: scale(0.995); }
          75% { filter: drop-shadow(0 0 25px rgba(255, 200, 0, 0.7)) drop-shadow(0 0 50px rgba(255, 0, 0, 0.4)); transform: scale(1.01); }
        }
        .flame-glow {
          animation: flame-flicker 2s infinite alternate cubic-bezier(0.45, 0.05, 0.55, 0.95);
        }
      `}</style>
          ...
          <div className="animate-pop-in flex flex-col items-center">
            ...
            <div className="relative group">
              ...
              <img
                ...
                className="relative w-auto h-[70vh] object-contain flame-glow"
                onError={(e) => {
